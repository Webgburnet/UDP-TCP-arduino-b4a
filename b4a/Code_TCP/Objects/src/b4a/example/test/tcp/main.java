...
public class main extends Activity implements B4AActivity{
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (isFirst) {
			processBA = new BA(this.getApplicationContext(), null, null, "b4a.example.test.tcp", "b4a.example.test.tcp.main");
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "b4a.example.test.tcp", "b4a.example.test.tcp.main");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "b4a.example.test.tcp.main", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
...
String _message = "";
 //BA.debugLineNum = 71;BA.debugLine="Sub Acquerir_capteur_Click";
...
_message = "";
 //BA.debugLineNum = 75;BA.debugLine="message=\"Acquer\"";
_message = "Acquer";
 //BA.debugLineNum = 76;BA.debugLine="Messages.Text=\"Acquisition des capteurs\"";
...
_emission = _bc.StringToBytes(_message,"ASCII");
 //BA.debugLineNum = 78;BA.debugLine="TCP_client.emission(emission)";
...
anywheresoftware.b4a.agraham.byteconverter.ByteConverter _bc = null;
String _message = "";
 //BA.debugLineNum = 61;BA.debugLine="Sub Arrete_Click";
 //BA.debugLineNum = 62;BA.debugLine="Dim emission() As Byte";
_emission = new byte[(int) (0)];
;
 //BA.debugLineNum = 63;BA.debugLine="Dim bc As ByteConverter";
_bc = new anywheresoftware.b4a.agraham.byteconverter.ByteConverter();
 //BA.debugLineNum = 64;BA.debugLine="Dim message As String";
_message = "";
 //BA.debugLineNum = 65;BA.debugLine="message=\"Arrete\"";
_message = "Arrete";
 //BA.debugLineNum = 66;BA.debugLine="Messages.Text=\"Arreter le Store\"";
mostCurrent._messages.setText((Object)("Arreter le Store"));
 //BA.debugLineNum = 67;BA.debugLine="emission=bc.StringToBytes(message,\"ASCII\")";
_emission = _bc.StringToBytes(_message,"ASCII");
 //BA.debugLineNum = 68;BA.debugLine="TCP_client.emission(emission)";
mostCurrent._tcp_client._emission(mostCurrent.activityBA,_emission);
...
String _message = "";
 ...
 //BA.debugLineNum = 40;BA.debugLine="Dim emission() As Byte";
_emission = new byte[(int) (0)];
;
 //BA.debugLineNum = 41;BA.debugLine="Dim bc As ByteConverter";
_bc = new anywheresoftware.b4a.agraham.byteconverter.ByteConverter();
 //BA.debugLineNum = 42;BA.debugLine="Dim message As String";
_message = "";
 //BA.debugLineNum = 43;BA.debugLine="message=EditText1.Text'\"EPrise\"";
_message = mostCurrent._edittext1.getText();
 //BA.debugLineNum = 44;BA.debugLine="Label1.Text=message";
mostCurrent._label1.setText((Object)(_message));
 //BA.debugLineNum = 45;BA.debugLine="emission=bc.StringToBytes(message,\"ASCII\")";
_emission = _bc.StringToBytes(_message,"ASCII");
 //BA.debugLineNum = 46;BA.debugLine="TCP_client.emission(emission)";
mostCurrent._tcp_client._emission(mostCurrent.activityBA,_emission);
 //BA.debugLineNum = 47;BA.debugLine="End Sub";
return "";
}
public static String  _connexion_click() throws Exception{
 //BA.debugLineNum = 34;BA.debugLine="Sub Connexion_Click";
 //BA.debugLineNum = 35;BA.debugLine="Adressepc=IP_Arduino_EditText.text";
_adressepc = mostCurrent._ip_arduino_edittext.getText();
 //BA.debugLineNum = 36;BA.debugLine="TCP_client.connexion(Adressepc,5500)";
mostCurrent._tcp_client._connexion(mostCurrent.activityBA,_adressepc,BA.NumberToString(5500));
...
mostCurrent._label1 = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 22;BA.debugLine="Private Arrete As Button";
mostCurrent._arrete = new anywheresoftware.b4a.objects.ButtonWrapper();
 //BA.debugLineNum = 23;BA.debugLine="Private Messages As Label";
mostCurrent._messages = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 24;BA.debugLine="Private Donnee_capteur As Label";
mostCurrent._donnee_capteur = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 25;BA.debugLine="Private Acquerir_capteur As Button";
...
public static String  _tcp_client_connected(boolean _succes) throws Exception{
 //BA.debugLineNum = 49;BA.debugLine="Sub TCP_client_Connected (Succes As Boolean)";
 //BA.debugLineNum = 50;BA.debugLine="If Succes = True Then";
if (_succes==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 51;BA.debugLine="Messages.Text=\"Connexion TCP réussit\"";
mostCurrent._messages.setText((Object)("Connexion TCP réussit"));
 };
...
String _message = "";
 //BA.debugLineNum = 55;BA.debugLine="Sub TCP_client_newdata(buffer() As Byte)";
 //BA.debugLineNum = 56;BA.debugLine="Dim message As String";
_message = "";
 //BA.debugLineNum = 57;BA.debugLine="message=BytesToString(buffer,0,buffer.Length,\"ASC";
_message = anywheresoftware.b4a.keywords.Common.BytesToString(_buffer,(int) (0),_buffer.length,"ASCII");
